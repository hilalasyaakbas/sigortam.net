...
document.addEventListener("DOMContentLoaded", function() {
    ...
    dropdowns.forEach(dropdown => {
        dropdown.addEventListener('click', function(event) {
            event.preventDefault(); // Linkin normal davranışını engeller (sayfa yenileme vb.)
            
            const dropdownMenu = dropdown.nextElementSibling;  // Açılacak dropdown menüsünü alıyoruz
